...
public class HexGrid : MonoBehaviour
{
	...
	public void ColorCell (Vector3 position, Color color) {
        ...
        DynLoadMaps.getInstance().SetCurrentTapPosUI(coordinates.X, coordinates.Z);
...

    {
        ...
        //label.gameObject.transform.SetRotationZ(45);
        label.gameObject.transform.Rotate(Vector3.forward,60,Space.Self);

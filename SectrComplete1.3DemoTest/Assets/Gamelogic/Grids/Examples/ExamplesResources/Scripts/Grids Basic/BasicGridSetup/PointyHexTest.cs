...
namespace Gamelogic.Grids.Examples
{
	public class PointyHexTest : GLMonoBehaviour
	{
		...
		private void BuildGrid()
		{
            ...
            //grid = PointyHexGrid<SpriteCell>.ThinRectangle(7, 7);
            grid = PointyHexGrid<SpriteCell>.Rectangle(7, 7);
            print(cellPrefab.Dimensions);
            print(Mathf.Sqrt(5216.25f));
			// Creates a map...
			map = new PointyHexMap(cellPrefab.Dimensions) // The cell dimensions usually correspond to the visual 
                ...
                .AlignBottomLeft(grid) // by this and the previous line.
                //.Rotate90()

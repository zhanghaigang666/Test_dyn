...
namespace Gamelogic.Grids2
{
	...
	public static class ImplicitShape
	{
		...
		private sealed class CircleShape2 : IImplicitShape<GridPoint2>
		{
			...
			private readonly Func<GridPoint2, float> norm;
			private readonly GridPoint2 center;
			...
			public CircleShape2(GridPoint2 center, float radius, Func<GridPoint2, float> norm)
			{
				this.center = center;
				this.radius = radius;
				this.norm = norm;
		...
		private static float ManhattanNorm(GridPoint2 point)
		{
			return Mathf.Abs(point.X) + Mathf.Abs(point.Y);
		}

		/// <summary>
		/// It get the Chebychev of a given point.
		/// </summary>
		/// <param name="point">Point to apply the operation.</param>
		private static float Chebychev(GridPoint2 point)
		{
			return Mathf.Max(Mathf.Abs(point.X), Mathf.Abs(point.Y));
		}

		/// <summary>
		/// It apply a Down Triangle norm to a given point.
		/// </summary>
		/// <param name="point">Point to apply the operation.</param>
		private static float DownTriangleNorm(GridPoint2 point)
		{
			return Mathf.Max(point.X, point.Y, -point.X - point.Y);
		}

		/// <summary>
		/// It apply a Up Triangle norm to a given point.
		/// </summary>
		/// <param name="point">Point to apply the operation.</param>
		private static float UpTriangleNorm(GridPoint2 point)
		{
			return Mathf.Max(-point.X, -point.Y, point.X + point.Y);
		}

		/// <summary>
		/// It apply a Hex norm to a given point.
		/// </summary>
		/// <param name="point">Point to apply the operation.</param>
		private static float HexNorm(GridPoint2 point)
		{
		...
		/// <summary>
		/// It creates a 2D Single Shape with a center value of (0,0)
		/// </summary>
		...
		/// <summary>
		/// It creates a 2D Single Shape with a given center value.
		/// </summary>
		...
		/// <summary>
		/// It creates a 2D Circle Shape with center in (0,0)
		/// </summary>
		/// <param name="radius">Radius for the sphere.</param>
		/// <param name="norm">This function is used to norm the points of the sphere.</param>
		public static IImplicitShape<GridPoint2> Circle(float radius, Func<GridPoint2, float> norm)
		{
			return new CircleShape2(GridPoint2.Zero, radius, norm);
		}

		/// <summary>
		/// It creates a 2D Convex Polygon given a IEnumerable of vertices.
		/// </summary>
		...
		/// <summary>
		/// It creates a 2D Rect Diamond Shape using a Circle Shape with a Manhattan Norm.
		/// </summary>
		/// <param name="center">Center point of the shape.</param>
		/// <param name="radius">Radius for the sphere.</param>		
		public static IImplicitShape<GridPoint2> RectDiamond(GridPoint2 center, float radius)
		{
			return Circle(center, radius, ManhattanNorm);
		}

		/// <summary>
		/// It creates a 2D Square Shape using a Circle Shape with a Chebychev norm.
		/// </summary>
		/// <param name="center">Center point of the shape.</param>
		/// <param name="radius">Radius for the sphere.</param>
		public static IImplicitShape<GridPoint2> Square(GridPoint2 center, float radius)
		{
		...
		/// <summary>
		/// It creates a 2D RectDiamond Shape using a Circle Shape with a Manhattan Norm.
		/// </summary>
		/// <param name="radius">Radius for the sphere.</param>
		...
		/// <summary>
		/// It creates a 2D Down Triangle Shape using a Circle Shape with a DownTriangle Norm.
		/// </summary>
		/// <param name="center">Center point of the shape.</param>
		/// <param name="radius">Radius for the sphere.</param>
		public static IImplicitShape<GridPoint2> DownTriangle(GridPoint2 center, float radius)
		{
			return Circle(center, radius, DownTriangleNorm);
		}

		/// <summary>
		/// It creates a 2D Down Triangle Shape using a Down Triangle Norm.
		/// </summary>
		/// <param name="radius">Radius for the sphere.</param>
		...
		/// <summary>
		/// It creates a 2D Up Triangle Shape using a Circle Shape with a UpTriangle Norm.
		/// </summary>
		/// <param name="center">Center point of the shape.</param>
		/// <param name="radius">Radius for the sphere.</param>
		public static IImplicitShape<GridPoint2> UpTriangle(GridPoint2 center, float radius)
		{
		...
		public static IImplicitShape<GridPoint2> Hexagon(GridPoint2 center, float radius)
		{
		...
		/// <param name="center">Center point of the shape.</param>
		/// <param name="radius">Radius of the shape.</param>
		public static IImplicitShape<GridPoint2> Star(GridPoint2 center, float radius)
		{
